use bevy::{app::AppExit, ecs::entity, prelude::*};
...
pub fn main_menu_plugin(app: &mut App) {
    app 
        ...
        .add_systems(OnEnter(GameState::MainMenu), alt_menu_setup)
...
const CRIMSON : Color = Color::rgb(0.863, 0.078, 0.235);
...
//Display and formatting for MainMenu
